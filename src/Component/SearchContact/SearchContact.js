...
const SearchContact = () => {
    ...
    return (
        ...
        <div className="home-fun">
                ...
                <div className="" >
                    <Button onClick={handleClickOpen} variant="contained" className="kop" >Redister Your Interest</Button>
...
<path d="M13 2L2 13M2 2L7.5 7.5L13 13" stroke="black" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</button>
          </DialogTitle>
